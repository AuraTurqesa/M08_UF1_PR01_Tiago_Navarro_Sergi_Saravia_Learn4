            ...
            TabView {
                ...
                VStack {
                    ...
                    List {
                        ...
                        .onDelete(perform: deleteTrivia) // Acción para eliminar
                        .onMove(perform: moveTrivia) // Acción para mover
                    }
                    .environment(\.editMode, .constant(.active)) // Permite la edición de la lista
                }
                .tabItem {
